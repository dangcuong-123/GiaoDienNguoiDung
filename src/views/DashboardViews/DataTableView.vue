...
<template>
  ...
  <v-container fill-height>
    ...
    <iframe class="my-10" src="https://clickermonkey.github.io/dayspan-vuetify/example/" width="100%" height="700px"
          frameborder="0"
          scrolling="no"
          marginheight="0"
          marginwidth="0"
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-checkbox v-model="editedItem.isAdmin" label="Admin" />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
...
export default {
  ...
  methods: {
    ...
    getusernames() {
      ...
      // { text: " ", value: "actions", sortable: false},
      this.userList = [
        {id: "1", nhom: "1", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "2", nhom: "2", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "3", nhom: "1", cong_viec: "Cho Lợn ăn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "4", nhom: "3", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "5", nhom: "2", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "6", nhom: "4", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},
     {id: "7", nhom: "5", cong_viec: "Dọn chuồng lợn",dia_diem: "Chuồng lợn số 2", bat_dau: "", ket_thuc: "", chi_tiet: ""},]
      // genericApi
